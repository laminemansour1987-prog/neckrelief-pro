...
Migraine clinics ask two questions you probably cannot answer: how many headache days last month, and how many rescue doses. This log answers both without you having to remember anything.
...
- Headache & Migraine Log — A4 (10 pages)
- Headache & Migraine Log — US Letter (10 pages)
...
Upload from `dist/headache-migraine-log/images/` in this order:
