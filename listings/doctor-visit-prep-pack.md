...
**€3.90** (about $4.50). Digital download, no shipping profile needed.
...
People forget roughly half of what is said in a medical appointment, and the appointment itself is ten minutes long. Writing it down beforehand and during is the entire trick.
...
- Doctor Visit Prep Pack — A4 (10 pages)
- Doctor Visit Prep Pack — US Letter (10 pages)
...
7. Appointment notes
8. After-visit plan
9. Notes & questions for next time
10. Before you start
...
Upload from `dist/doctor-visit-prep-pack/images/` in this order:
