...
Most desk pain is a geometry problem before it is a muscle problem. Fix the geometry once, then build the two or three habits that stop it coming back.
...
3. Desk setup audit
4. Posture habit tracker
5. Workday discomfort log
6. Desk stretch card
7. Weekly review
8. Notes
9. Before you start
...
Upload from `dist/posture-desk-setup-kit/images/` in this order:
